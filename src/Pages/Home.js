                ...
                <div className="cards card2">
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      ...
                      <p> $EXPO is a farm-trade-seed-as-a-service run by
                        the community for the community. </p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="carousel-item" data-bs-interval="40000">
                <div className="cards card3">
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <h1>MidadDao</h1>
                      <p>Automated treasury growth protocol with a steady
                        flow of revenues from Yield farming, Metaverse and
                        P2E that rewards $CROWN investors and $THRONE
                        node holders.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="carousel-item " data-bs-interval="40000">
                <div className="cards card4">
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <h1>D3Protocol</h1>
                      <p>$DeFi 3.0 Staking-as-a-Service and index.
                        Stake. Mint. Earn.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="cards card5">
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      ...
                      <p>$CCF :: First Farming As a Service on
        ...
        <div className="row">
          <div className="col-md-4 links">
            <ul>
              ...
              <Link to='/'><li>Contracts</li></Link>
            </ul>
          </div>
          <div className="col-md-4 logo">
            <img src={require('../Images/footer-logo.png')} alt="footerimg" />
          </div>
          <div className="col-md-4 second-links"><ul>
            <Link to='/'><li>Links</li></Link>
            <Link to='/'><li>twitter</li></Link>
            <Link to='/'><li>Medium</li></Link>
            <Link to='/'><li>Telegram</li></Link>
